...
RENAMED VALUE_AT_START_OF_TWEEN to AUTO_TWEEN_VALUE and moved it to a global file. Fixed a bug where this wasn't working. Also added this to KSSimpleTween.
