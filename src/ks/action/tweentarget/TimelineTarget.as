package ks.action.tweentarget
{
	 ...
	 */
	// todo: add example
	public class TimelineTarget implements ITweenTarget
	{
		 ...
		 */
		public function TimelineTarget(target:MovieClip, startFrame:Object = null, endFrame:Object = null) {
			this.target = target;
		 ...
		 */
		private function getFrameNumberForLabel(target:MovieClip, label:String):int
		{
		...
		public function clone():ITweenTarget {
			return new TimelineTarget(_target, _startValue, _endValue);
		}
