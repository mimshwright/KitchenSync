package ks.action.tweentarget
{
	...
	public class SimpleBlurTweenTarget implements IFilterTweenTarget
	{
		...
		public function SimpleBlurTweenTarget(target:DisplayObject, startValue:Number, endValue:Number = 0) {
			...
			_blurXTweenTarget = new FilterPropertyTweenTarget(target, BlurFilter, "blurX", _startValue, _endValue);
			_blurYTweenTarget = new FilterPropertyTweenTarget(target, BlurFilter, "blurY", _startValue, _endValue);
		}
		
		/** Tween target for adjusting the x property. */
		protected var _blurXTweenTarget:FilterPropertyTweenTarget;
		/** Tween target for adjusting the y property. */
		protected var _blurYTweenTarget:FilterPropertyTweenTarget;
