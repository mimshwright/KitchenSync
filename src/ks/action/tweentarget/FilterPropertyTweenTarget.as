package ks.action.tweentarget
{
	 ...
	 * @since 1.5 
	 */ 
	public class FilterPropertyTweenTarget implements IFilterTweenTarget
	{
		/**
		 ...
		 */
		public function FilterPropertyTweenTarget (target:DisplayObject, filterType:Class, property:String, startValue:Number = NaN, endValue:Number = NaN) {
			_target = target;
		...
		{
			return new FilterPropertyTweenTarget(_target, _filterType, _property, _startValue, _endValue);
