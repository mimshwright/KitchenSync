package ks.action.tweentarget
{
	...
	public class SoundTransformTweenTarget implements ITweenTarget
	{
		 ...
		 */
		public function SoundTransformTweenTarget (targetSound:Object, property:String = null, startValue:Number = NaN, endValue:Number = NaN) {
		...
		{ 
			return new SoundTransformTweenTarget(_targetSound, _property, _startValue, _endValue);
