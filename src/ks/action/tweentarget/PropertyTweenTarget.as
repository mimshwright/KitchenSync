package ks.action.tweentarget
{
	 ...
	 */
	public class PropertyTweenTarget implements ITweenTarget
	{
		 ...
		 */
		public function PropertyTweenTarget (target:Object, property:String, startValue:Number = NaN, endValue:Number = NaN) {
		...
		public function clone():ITweenTarget {
			var clone:PropertyTweenTarget = new PropertyTweenTarget(_target, _property, _startValue, _endValue);
		 ...
		 */
		public function cloneWithTarget (target:Object, property:String = ""):PropertyTweenTarget {
			var clone:PropertyTweenTarget = this.clone() as PropertyTweenTarget;
